...
\title{Dual host-parasite transcriptomes of apicomplexan \textit{Eimeria falciformis} and its natural mouse host}
...
In total, xx reads were sequenced. For each sample, mouse read numbers were 10⁷ - 10⁸
...
\subsection{Sequencing, quality assessment and alignment}
cDNA samples were sequenced by either GAIIX or Illumina Hiseq 2000 as specified in SI xx (both unstranded). Fastq\_quality\_filter was applied to Illumina Hiseq 2000 samples. 
